...
//        Driver driver = DriverManager.getDriver("jdbc:derby:/C/jetbrains/env/db/demo_db;create=true");
//        Connection connection = driver.connect("jdbc:derby:/C/jetbrains/env/db/demo_db;create=true", new Properties());
//
//        String databaseURL = "jdbc:derby:C:/jetbrains/env/db/demo_db;create=true";
