...
public class DatabaseUserRepository implements UserRepository {
    ...
    public boolean save(User user) {
        int num = executeUpdate("INSERT INTO users(name, password, email, phoneNumber) values(?,?,?,?)",
    ...
    public boolean deleteById(Long userId) {
        int num = executeUpdate("REMOVE users where id=?",
                COMMON_EXCEPTION_HANDLER,
                userId);
        return num > 0;
    }
    ...
    public boolean update(User user) {
        int num = executeUpdate("UPDATE users SET name=?, password=?, email=?, phoneNumber=?",
                COMMON_EXCEPTION_HANDLER,
                user.getName(),
                user.getPassword(),
                user.getEmail(),
